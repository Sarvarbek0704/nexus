...
import { Briefcase, Plus, Loader2, BarChart2, Eye, Users } from 'lucide-react';
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            {meta?.total ? `${meta.total} posted projects` : 'Manage your posted projects'}
          </p>
        </div>
        <Link
          href="/projects/post"
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            {status === 'all' ? "You haven't posted any projects yet." : `No ${status.replace('_', ' ')} projects.`}
          </p>
          {status === 'all' && (
            <Link
              href="/projects/post"
            ...
            >
              ...
              <div className="flex items-center gap-3 text-xs text-gray-400">
                <span className="flex items-center gap-1">
                  ...
                  {project._count?.bids ?? project.bidsCount ?? 0} bids
                </span>
                <span className="flex items-center gap-1">
