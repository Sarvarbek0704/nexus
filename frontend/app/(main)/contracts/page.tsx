  ...
  return (
    <div className="p-6 space-y-5">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your active and past contracts.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            {activeStatus === 'all' ? 'No contracts yet.' : `No ${activeStatus} contracts.`}
          </p>
        </div>
      ) : (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mt-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          Started {formatRelativeTime(contract.startDate || contract.createdAt)}
                        </span>
                        {contract.endDate && (
                          <span className="flex items-center gap-1">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      {contract.escrowAmount ? `${formatCurrency(contract.escrowAmount)} in escrow` : 'No escrow'}
                    </p>
                ...
                <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-400">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    Platform fee: {contract.platformFeePercent}%
                  </span>
